...
/// <summary>
/// Paralax Scrolling que debe ser añadido a una Capa.
/// </summary>
public class ScrollingScript : MonoBehaviour
{
	...
	void Update()
	{
        ...
        if (MaxY > transform.position.y) movement.y = 0;
		...
		if (isLooping)
		{
            ...
            else
            {
                if (firstChild != null)
                {
                    // Verificamos si el fondo esta abajo de la pantalla
                    if (firstChild.transform.position.y < Camera.main.transform.position.y)
                    {
                        ...
                        if (firstChild.IsVisibleFrom(Camera.main) == false)
                        {
                            ...
                            //Posicionamos el fondo actual a arriba.
                            firstChild.transform.position = new Vector3(lastPosition.x, lastPosition.y+lastSize.y, firstChild.transform.position.z);
